...
const POKEMON = {
  'venusaur': {
    ...
    weight: 100, formWeights: { 'mega': 155.5 },
  ...
  'charizard': {
    ...
    weight: 90.5, formWeights: { 'mega-x': 110.5, 'mega-y': 100.5 },
  ...
  'blastoise': {
    ...
    weight: 85.5, formWeights: { 'mega': 101.1 },
  ...
  'beedrill': {
    ...
    weight: 29.5, formWeights: { 'mega': 40.5 },
  ...
  'pidgeot': {
    ...
    weight: 39.5, formWeights: { 'mega': 50.5 },
  ...
  'raichu': {
    ...
    weight: 30, formWeights: { 'alola': 21 },
    abilities: [{"id":"static","name":"静电","nameEn":"Static","isHidden":false},{"id":"lightning-rod","name":"避雷针","nameEn":"Lightning Rod","isHidden":true}],
  ...
  'medicham': {
    ...
    weight: 31.5, formWeights: { 'mega': 31.5 },
  ...
  'manectric': {
    ...
    weight: 40.2, formWeights: { 'mega': 44 },
  ...
  'sharpedo': {
    ...
    weight: 88.8, formWeights: { 'mega': 130.3 },
  ...
  'camerupt': {
    ...
    weight: 220, formWeights: { 'mega': 320.5 },
  ...
  'banette': {
    ...
    weight: 12.5, formWeights: { 'mega': 13 },
  ...
  'glalie': {
    ...
    weight: 256.5, formWeights: { 'mega': 350.2 },
  ...
  'avalugg': {
    ...
    weight: 505, formWeights: { 'hisui': 262.4 },
  ...
  'ninetales': {
    ...
    weight: 19.9, formWeights: { 'alola': 19.9 },
  ...
  'arcanine': {
    ...
    weight: 155, formWeights: { 'hisui': 168 },
  ...
  'slowbro': {
    ...
    weight: 78.5, formWeights: { 'galar': 70.5, 'mega': 120 },
  ...
  'gengar': {
    ...
    weight: 40.5, formWeights: { 'mega': 40.5 },
  ...
  'kangaskhan': {
    ...
    weight: 80, formWeights: { 'mega': 100 },
  ...
  'tauros': {
    ...
    weight: 88.4, formWeights: { 'paldea': 110 },
  ...
  'gyarados': {
    ...
    weight: 235, formWeights: { 'mega': 305 },
  ...
  'typhlosion': {
    ...
    types: ["fire"],
    baseStats: { hp: 78, atk: 84, def: 78, spa: 109, spd: 85, spe: 100 },
    weight: 79.5, formWeights: { 'hisui': 69.8 },
  ...
  'ampharos': {
    ...
    weight: 61.5, formWeights: { 'mega': 61.5 },
  ...
  'slowking': {
    ...
    weight: 79.5, formWeights: { 'galar': 79.5 },
    abilities: [{"id":"oblivious","name":"迟钝","nameEn":"Oblivious","isHidden":false},{"id":"own-tempo","name":"我行我素","nameEn":"Own Tempo","isHidden":false},{"id":"regenerator","name":"再生力","nameEn":"Regenerator","isHidden":true}],
  ...
  'steelix': {
    ...
    weight: 400, formWeights: { 'mega': 740 },
  ...
  'scizor': {
    ...
    weight: 118, formWeights: { 'mega': 125 },
  ...
  'heracross': {
    ...
    weight: 54, formWeights: { 'mega': 62.5 },
  ...
  'houndoom': {
    ...
    weight: 35, formWeights: { 'mega': 49.5 },
  ...
  'tyranitar': {
    ...
    weight: 202, formWeights: { 'mega': 255 },
  ...
  'gardevoir': {
    ...
    weight: 48.4, formWeights: { 'mega': 48.4 },
  ...
  'sableye': {
    ...
    weight: 11, formWeights: { 'mega': 161 },
  ...
  'aggron': {
    ...
    weight: 360, formWeights: { 'mega': 395 },
  ...
  'altaria': {
    ...
    weight: 20.6, formWeights: { 'mega': 20.6 },
  ...
  'metagross': {
    ...
    weight: 550, formWeights: { 'mega': 942.9 },
  ...
  'lopunny': {
    ...
    weight: 33.3, formWeights: { 'mega': 28.3 },
  ...
  'lucario': {
    ...
    weight: 54, formWeights: { 'mega': 57.5 },
  ...
  'abomasnow': {
    ...
    weight: 135.5, formWeights: { 'mega': 185 },
  ...
  'gallade': {
    ...
    weight: 52, formWeights: { 'mega': 56.4 },
  ...
  'samurott': {
    ...
    weight: 94.6, formWeights: { 'hisui': 58.2 },
  ...
  'zoroark': {
    ...
    weight: 81.1, formWeights: { 'hisui': 73 },
  ...
  'stunfisk': {
    ...
    weight: 11, formWeights: { 'galar': 20.5 },
  ...
  'decidueye': {
    ...
    weight: 36.6, formWeights: { 'hisui': 37 },
  ...
  'goodra': {
    ...
    weight: 150.5, formWeights: { 'hisui': 334.1 },
