...
const MOVES = {
  ...
  'blizzard': { name: '暴风雪', nameEn: 'Blizzard', type: 'ice', category: 'special', power: 110, accuracy: 70, pp: 5, priority: 0, note: '冰雹天气必中' },
  ...
  'freeze-dry': { name: '冷冻干燥', nameEn: 'Freeze-Dry', type: 'ice', category: 'special', power: 70, accuracy: 100, pp: 20, priority: 0, note: '对水属性超效' },
  ...
  'drill-run': { name: '直冲钻', nameEn: 'Drill Run', type: 'ground', category: 'physical', power: 80, accuracy: 95, pp: 10, priority: 0, note: '高急所率' },
  ...
  'psycho-cut': { name: '精神利刃', nameEn: 'Psycho Cut', type: 'psychic', category: 'physical', power: 70, accuracy: 100, pp: 20, priority: 0, note: '高急所率' },
  ...
  // ========== 岩石属性 ==========
  'stone-edge': { name: '尖石攻击', nameEn: 'Stone Edge', type: 'rock', category: 'physical', power: 100, accuracy: 80, pp: 5, priority: 0, note: '高急所率' },
  ...
  'shadow-claw': { name: '暗影爪', nameEn: 'Shadow Claw', type: 'ghost', category: 'physical', power: 70, accuracy: 100, pp: 15, priority: 0, note: '高急所率' },
  ...
  'wicked-blow': { name: '暗冥强击', nameEn: 'Wicked Blow', type: 'dark', category: 'physical', power: 75, accuracy: 100, pp: 5, priority: 0, note: '必定急所' },
  ...
  'surging-strikes': { name: '水流连打', nameEn: 'Surging Strikes', type: 'water', category: 'physical', power: 25, accuracy: 100, pp: 5, priority: 0, note: '必定命中3次，必定急所' },
  ...
  'flower-trick': { name: '千变万花', nameEn: 'Flower Trick', type: 'grass', category: 'physical', power: 70, accuracy: 0, pp: 10, priority: 0, note: '必定命中，必定急所' },
  ...
  'cross-chop': { name: '十字劈', nameEn: 'Cross Chop', type: 'fighting', category: 'physical', power: 100, accuracy: 80, pp: 5, priority: 0, note: '高急所率' },
  ...
  // ========== 恶属性（补充） ==========
  'night-slash': { name: '暗袭要害', nameEn: 'Night Slash', type: 'dark', category: 'physical', power: 70, accuracy: 100, pp: 15, priority: 0, note: '高急所率' },
  ...
  'snipe-shot': { name: '狙击', nameEn: 'Snipe Shot', type: 'water', category: 'special', power: 80, accuracy: 100, pp: 15, priority: 0, note: '无视重定向效果，高急所率' },
